...
- **Project count** — the spec said 4 (§6.6), 6 (§9), and "7+" (stats widget). Resolved: **6** projects render; the By-the-Numbers stat changes from "7+" to "6".
...
> **Dev:** And the stats widget says "Projects 7+", but the Dossier has 6 cards.
> **Chan:** Show 6. The "7" was the seven Huawei automation tools — that's one project, not seven. Make the number match the cards: 6.
